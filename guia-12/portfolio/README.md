...
Cada TP tiene un entregable concreto en GitHub con los archivos y ejercicios realizados.
...
La aplicación de notas se amplió en cada TP hasta integrar el siguiente recorrido:
...
- los archivos correspondientes al ejercicio
